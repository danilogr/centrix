   ...
   mov  cx,16		; sao 16 nomes por setor, caso o arquivo seja encontrado primeiro não será necessario o loop de 16 vezes
     ...
     procuranome:	   	;faz a procura do nome desejado
      ...
      mov bx,[addrss]		;endereco de pesquisa
       ...
       xor bx,bx		; bx sera o contador de string 
       xor ax,ax		; ax sera utilizado para a string ( na comparacao )
         ...
         verificastring:
           ...
           mov ah,  [bx]    	     ; 						
           pop  bx		     ;
           cmp byte [nome + bx], ah  ; pega uma letra e compara
           jne ncontinua	     ; se nao for igual, vai para ncontinua
           inc bx		     ; incrementa para a proxima pesquisa
           cmp bx,11		     ; se bx = 12, entao ja lemos 11 caracteres que portanto estao certas, logo o arquivo é o procurado
           jl  verificastring        ; se for menor entao verifica a proxima caractere
           ;se estivar aqui entao todas as caracteres sao iguais
